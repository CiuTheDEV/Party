    ...
    bindings: [
      {
        id: 'keyboard-left',
        title: 'Lewo',
        description: 'Przesuwa fokus interfejsu albo wybór o jedną pozycję w lewo.',
        device: 'keyboard',
        section: 'Klawiatura',
        primaryInputLabel: 'A',
      ...
      },
      {
        id: 'keyboard-right',
        title: 'Prawo',
        description: 'Przesuwa fokus interfejsu albo wybór o jedną pozycję w prawo.',
        device: 'keyboard',
        section: 'Klawiatura',
        primaryInputLabel: 'D',
      ...
      },
      {
        id: 'keyboard-up',
        title: 'Góra',
        description: 'Przesuwa fokus interfejsu albo wybór o jedną pozycję w górę.',
        device: 'keyboard',
        section: 'Klawiatura',
        primaryInputLabel: 'W',
      ...
      },
      {
        id: 'keyboard-down',
        title: 'Dół',
        description: 'Przesuwa fokus interfejsu albo wybór o jedną pozycję w dół.',
        device: 'keyboard',
        section: 'Klawiatura',
        primaryInputLabel: 'S',
      ...
      },
      {
        ...
        description: 'Otwiera ustawienia gry lub menu pauzy w zależności od ekranu.',
        device: 'keyboard',
        section: 'Klawiatura',
      ...
      },
      {
        id: 'keyboard-confirm',
        title: 'Potwierdź',
        description: 'Zatwierdza aktualny wybór albo uruchamia główną akcję na aktywnym elemencie.',
        device: 'keyboard',
        section: 'Klawiatura',
